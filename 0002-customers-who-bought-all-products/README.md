<h2><a href="https://leetcode.com/problems/customers-who-bought-all-products/?envType=problem-list-v2&envId=db-db3-grouping-aggregation">2. Customers Who Bought All Products</a></h2><h3>Medium</h3><hr><p>Table: <code>Customer</code></p>
